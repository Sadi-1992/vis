...
Core.prototype._redraw = function() {
  ...
  tmp.topHeight = dom.top.clientHeight;
  tmp.bottomHeight = dom.bottom.clientHeight;

  if (this.tmpData.topHeight && (difTop <= 5 || difTop >= -5)) {
    props.top.height = this.tmpData.topHeight;
  } else {
    props.top.height = tmp.topHeight || -props.border.top;
    this.tmpData.topHeight = tmp.topHeight;
  }

  if (this.tmpData.bottomHeight && (difTop <= 5 || difTop >= -5)) {
    props.bottom.height = this.tmpData.bottomHeight;
  } else {
    props.bottom.height = tmp.bottomHeight || -props.border.bottom;
    this.tmpData.bottomHeight = tmp.bottomHeight;
  }
